...
SftpConfig ={
        "host":str(getenv("SFTP_HOST")), #ip de la base de datos principal de xentric
        "port":int(getenv("SFTP_PORT")), #puerto de la base de datos principal de xentric
        "user":str(getenv("SFTP_USERNAME")), #usuario de la base de datos principal de xentric
        "pass":str(getenv("SFTP_PASS")),#contraseña de la base de datos principal de xentric
}
...
app.config['SftpConfig'] = SftpConfig #asignamos la configuracion de SFTP a la app
